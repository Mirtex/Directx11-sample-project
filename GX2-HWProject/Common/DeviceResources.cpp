...
void DX::DeviceResources::CreateWindowSizeDependentResources() 
{
	...
	m_minimapViewport = CD3D11_VIEWPORT(
		m_d3dRenderTargetSize.Width *0.75f,
		m_d3dRenderTargetSize.Height*0.75f,
		m_d3dRenderTargetSize.Width*0.23f,
		m_d3dRenderTargetSize.Height*0.23f

		);


	//m_screenViewport[1] = CD3D11_VIEWPORT(
	//	m_d3dRenderTargetSize.Width / 8,
	//	m_d3dRenderTargetSize.Height / 8,
	//	m_d3dRenderTargetSize.Width,
	//	m_d3dRenderTargetSize.Height
