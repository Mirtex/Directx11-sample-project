...
void App::SetWindow(CoreWindow^ window)
{
	...
	window->PointerExited +=
		ref new Windows::Foundation::TypedEventHandler<Windows::UI::Core::CoreWindow ^, Windows::UI::Core::PointerEventArgs ^>(this, &GX2_HWProject::App::OnPointerExited);
...
void App::Load(Platform::String^ entryPoint)
{
	if (m_main == nullptr)
	{
		m_main = std::unique_ptr<GX2_HWProjectMain>(new GX2_HWProjectMain(m_deviceResources));
	}
}
...
void GX2_HWProject::App::OnPointerExited(Windows::UI::Core::CoreWindow ^sender, Windows::UI::Core::PointerEventArgs ^args)
{
	diffx = 0;
	diffy = 0;
	left_click = false;
...
void GX2_HWProject::App::OnKeyDown(Windows::UI::Core::CoreWindow ^ sender, Windows::UI::Core::KeyEventArgs ^ args)
{
...
void GX2_HWProject::App::OnKeyUp(Windows::UI::Core::CoreWindow ^ sender, Windows::UI::Core::KeyEventArgs ^ args)
{
